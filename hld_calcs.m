...
hld.Cl_base = 0.85; % generated w/ OpenVSP
...
fprintf('Cl deficit for runway req: %0.5f\n', hld.dCl_req);
fprintf('Cl deficit for constraint plot: %0.5f\n', 1.75-hld.Cl_base);
%% DATCOM 1978: Flaps for supersonic airfoil 
% p. 8-13 
...
n_delta = 0.9; % corresponding to 20 degree deflection angle
