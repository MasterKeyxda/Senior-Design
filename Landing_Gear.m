...
x_MAC_cg = x_MACpercent * WING.MAC; % distance from leading edge of MAC to aircraft cg
C_r = 23.425; %  root chord (ft)
x_RootLE_MACLE = (C_r - WING.MAC)/2; % Distance from LE Root to LE MAC
...
Fn = Bm./B * WTO; % Force of Static Load on Nose Gear (lbf)
Fm = Bn./B * WTO; % Force of Static Load on Main Gear (lbf)
PercentFn = Fn/WTO * 100; % percentage of loading on nose gear
PercentFm = Fm/WTO * 100; % percentage of loading on main gear
